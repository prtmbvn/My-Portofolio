...
const SocialSidebar = () => {
  return (
    <div className="hidden lg:flex fixed right-8 top-1/2 -translate-y-1/2 flex-col gap-6 z-50">
      <SocialIcon>
...
// Sub-component kecil untuk menghindari repetisi
const SocialIcon = ({ children }) => (
  <a className="w-10 h-10 flex items-center justify-center rounded-full border border-ink/20 text-ink hover:bg-primary hover:text-ink hover:border-primary transition-all shadow-sm" href="#">
    {children}
  </a>
);
